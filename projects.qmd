...
## Laboratory of Social Open Science (LISA-COES)

::: {.grid}

::: {.g-col-12 .g-col-md-2}
[![](https://lisacoes.com/resources/imagenes/logo.png)](https://lisacoes.com/)

:::

::: {.g-col-12 .g-col-md-10}

I worked as a research assistant for the [Laboratory of Social Open Science (LISA-COES)](https://lisacoes.com/), where I contributed to the development of open science practices in social research. My responsibilities included data management, statistical analysis, and the creation of reproducible research materials using R and Git. I also supported the preparation of academic publications and public engagement materials, fostering transparency and accessibility in social science research.
